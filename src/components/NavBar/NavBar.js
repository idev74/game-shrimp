    ...
    return (
        <section className="my-7 sticky top-0">
            <nav id="nav" className="flex flex-row p-3 mt-auto mb-auto justify-center">
                <NavLink
                    className="inline-block rounded py-2 px-4 hover:bg-cyan-500 bg-purple-500 text-white outline-double outline-3 active:outline-offset-4 mx-5 shadow-lg shadow-cyan-300/75"
                    to="/">Home</NavLink>
                <NavLink
                    className="inline-block rounded py-2 px-4 hover:bg-cyan-500 bg-purple-500 text-white outline-double outline-3 active:outline-offset-4 mx-5 shadow-lg shadow-cyan-300/75"
